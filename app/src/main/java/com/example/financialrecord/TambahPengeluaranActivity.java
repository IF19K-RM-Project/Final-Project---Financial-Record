...
//        AdRequest adRequest = new AdRequest.Builder().build();
        ...
        eText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(id.my.cariberas.pengeluaranharian.TambahPengeluaranActivity.this,
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (ePengeluaran.getText().toString().equals("") || eText.getText().toString().equals("") || eHarga.getText().toString().equals("")){
                    Toast.makeText(id.my.cariberas.pengeluaranharian.TambahPengeluaranActivity.this,"Semua Data Harus Diisi!", Toast.LENGTH_SHORT ).show();
                }else {
...
//                        Toast.makeText(TambahPengeluaranActivity.this,"cocok!", Toast.LENGTH_SHORT ).show();
                        ...
                        Toast.makeText(id.my.cariberas.pengeluaranharian.TambahPengeluaranActivity.this,"Format tanggal salah!", Toast.LENGTH_SHORT ).show();
                    }
                }
            }
        });
