    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(id.my.cariberas.pengeluaranharian.LaporanLainnyaActivity.this,
            ...
            btnLihat.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (eText.getText().toString().equals("") || eText2.getText().toString().equals("")){
                        Toast.makeText(id.my.cariberas.pengeluaranharian.LaporanLainnyaActivity.this,"Data tidak boleh kosong!!", Toast.LENGTH_SHORT ).show();
                    }else {
                        if(!isValidDate(eText.getText().toString())){
                            Toast.makeText(id.my.cariberas.pengeluaranharian.LaporanLainnyaActivity.this,"Format tanggal salah!!", Toast.LENGTH_SHORT ).show();
